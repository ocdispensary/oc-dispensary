...
(function () {
  ...
  modal.innerHTML = `
    ...
    <h2>By clicking “YES” and entering the website, I agree to be bound by the Terms of Service, Privacy Policy and Notice of Privacy Practices. *For medical purchases in CA, CT, FL, IL, MA, MN, MD, NV, NY, PA, RI and VA patients must be 18+.</h2>
  ...
  document.getElementById('age-no').addEventListener('click', () => {
    modal.innerHTML = `
      <h2">Sorry!</h2>
        <h2>You must be 21 years or older to enter this site.</h2>
